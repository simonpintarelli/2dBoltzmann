...
/**
 * \f$ \int_\mathbb{R} g(x) exp(-x^2) \mathrm{d}\,x \approx \sum_{i=1}^n (g(x_i) exp(-x^2)) w_i \f$
 *
 * \remark{In order to avoid numerical  underflow in the weights \f$ w_i \f$ and overflow in
 * the evaluation of the integrad, the weights contain the factor \f$ exp(x_i^2) \f$}
 *
