...
sentry<NUMERIC_T>::coeff(int i, int j, int t)
{
  ...
  // cout << "v0:\t";
  // for_each(v0.begin(), v0.end(), [](numeric_t v) { cout << v << "\t"; });
  // cout << endl;
  ...
  // cout << "v1:\t";
  // for_each(v1.begin(), v1.end(), [](numeric_t v) { cout << v << "\t"; });
  // cout << endl;
  ...
  // cout << "v2:\t";
  // for_each(v2.begin(), v2.end(), [](numeric_t v) { cout << v << "\t"; });
  // cout << endl;
  ...
  // cout << "v3:\t";
  // for_each(v3.begin(), v3.end(), [](numeric_t v) { cout << v << "\t"; });
  // cout << endl;
  ...
  // cout << "v4:\t";
  // for_each(v4.begin(), v4.end(), [](numeric_t v) { cout << v << "\t"; });
  // cout << endl;
...
sentry<NUMERIC_T>::operator()(int i, int j, numeric_t x)
{
  ...
  for (int l = std::abs(i - j); l <= i + j; l += 2) {
    ...
    // cout << "l = " << l << ",\t" << scientific << setprecision(8) << loc;
    // int t = (i+j-l)/2;
    // cout << "\t t=" << t << endl;
