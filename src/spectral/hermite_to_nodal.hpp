...
class Hermite2Nodal
{
 ...
 public:
   ...
   * @param init   functor to initialize the 1d trafo matrix (initializers can be found in
   * h2n_1d.hpp)
   */
   ...
   *
   * @param dst Output Nodal coefficients dst(i,j) corresponds to nodes \f$ x_i, y_j\f$.
