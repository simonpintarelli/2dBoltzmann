...
if(Boost_NUMPY3_FOUND OR Boost_NUMPY_FOUND)
  ...
  # elseif(Boost_NUMPY_FOUND and NOT PYTHON_VERSION_STRING GREATER 3.0)
  #   message("FindBoostNpy (official boost): boost-libs=${Boost_LIBRARIES}")
  #   set(BOOST_NPY_LIBRARIES "${Boost_LIBRARIES}")
  #   set(BOOST_NPY_INCLUDE_DIR "${Boost_INCLUDE_DIR}")
  #   set(_OFFICIAL_BOOST_NUMPY_FOUND True)
...
# # Attempt to load a user-defined configuration for BOOST_NPY if couldn't be found
# if ( NOT BOOST_NPY_INCLUDE_DIR OR NOT BOOST_NPY_LIBRARIES_DIR )
#   include( BOOST_NPYConfig OPTIONAL )
# endif()
