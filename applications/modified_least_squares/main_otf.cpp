...
#ifdef TIMING
#include "trilinos/gmres_solver.hpp"
#include "trilinos/ilu_preconditioner.hpp"
#endif
...
#ifndef TIMING
      ("condest", "estimate condition number")("export-matrices", "export matrices as hdf5")
#else
      ("nrep", po::value<int>()->default_value(200), "num repetitions")
#endif
      ;
